...
#define SD_CARD // If SD card reader on shield not working, comment out this line

// If SD card is working, declare variables to store credentials from SD card
#ifdef SD_CARD
...
// If SD card is not working, include credentials from secrets header file
#else
#include "secrets.h"
#endif
